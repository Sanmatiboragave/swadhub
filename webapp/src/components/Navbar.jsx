  ...
  return (
    <header className="glass-nav sticky top-0 z-40">
      <div className="section-pad flex flex-wrap items-center gap-3 py-3 sm:gap-4 sm:py-4">
        <Link to="/" className="font-display text-4xl font-800 tracking-tight text-zest-600 sm:text-5xl" style={{ fontWeight: 800 }}>
          SwadHub
        </Link>
        ...
        >
          <FiMapPin className="shrink-0 text-zest-500" size={24} />
        ...
        {showSearch && (
          <div className="order-3 flex w-full flex-1 items-center gap-2 rounded-2xl bg-white px-3 py-2.5 shadow-sm ring-1 ring-zest-100 sm:order-none sm:min-w-[220px]">
            <FiSearch className="text-zest-500" size={24} />
            <input
              value={search || ''}
        ...
        <div className="ml-auto flex items-center gap-2">
          <Link to="/login" className="inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold text-zest-600 hover:bg-zest-50 transition">
            Log in
          </Link>
          <Link to="/signup" className="inline-flex items-center gap-2 rounded-xl bg-zest-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lift hover:bg-zest-600 transition">
            Sign up
          </Link>
        </div>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-2xl bg-ink-900 px-4 py-2.5 text-sm font-semibold text-white shadow-lift transition hover:-translate-y-0.5"
        >
